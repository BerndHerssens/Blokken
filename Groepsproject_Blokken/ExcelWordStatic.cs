...
namespace Groepsproject_Blokken
{
    internal class ExcelWordStatic
    {
        ...
        public static void PrintExcel(List<Player> lijstPlayers)
        {
            ...
            //chartRange = xlWorksheet.get_Range("A3:A" + maxrij.ToString() + ";C3:C" + maxrij.ToString());
            ...
            //chart.Axes(Excel.XlAxisType.xlCategory).AxisTitle.Characters.Text = "Studenten";
            //chart.Axes(Excel.XlAxisType.xlValue).HasTitle = true;
            //chart.Axes(Excel.XlAxisType.xlValue).AxisTitle.Characters.Text = "Punten";
